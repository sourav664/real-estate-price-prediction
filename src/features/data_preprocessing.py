...
ordinal_encode = ['luxury_category',
                  'floor_category']

target_encode = ['regions',
                 'property_type']
...
def train_processor(preprocessor,X_train: pd.DataFrame, y_train: pd.DataFrame):
...
if __name__ == '__main__':
    ...
    train_processor(preprocessor=preprocessor, X_train=X_train, y_train=y_train)
